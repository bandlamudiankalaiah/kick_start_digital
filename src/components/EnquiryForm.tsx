...
export const EnquiryForm: React.FC<EnquiryFormProps> = ({
  ...
  return (
    <section 
      ...
      className="py-16 md:py-24 bg-slate-950 text-slate-200 relative overflow-hidden border-b border-slate-800"
    >
      {/* Background Glow */}
      <div 
        aria-hidden="true" 
        className="absolute top-1/4 -left-32 w-96 h-96 bg-indigo-500/10 rounded-full blur-3xl pointer-events-none" 
      />
      <div 
        aria-hidden="true" 
        className="absolute bottom-10 -right-32 w-96 h-96 bg-indigo-600/10 rounded-full blur-3xl pointer-events-none" 
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="pt-2 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                <a
                  ...
                  className="p-3 rounded-xl bg-slate-900 border border-slate-800 hover:border-slate-700 transition-colors flex items-center gap-2.5"
                >
                  <Mail className="w-4 h-4 text-indigo-400" />
                  <div>
                    <span className="font-semibold text-white block">Jana</span>
                    <span className="text-slate-400 text-[11px] block truncate">{AGENCY_INFO.contacts.jana}</span>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="text-slate-400 text-[11px] block truncate">{AGENCY_INFO.contacts.lakshmi}</span>
                  </div>
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 text-xs text-slate-400 pt-2">
              ...
              <span>Average response time: <strong className="text-slate-200">under 2 hours</strong> during NZ business hours.</span>
            </div>
          ...
          <div className="lg:col-span-7">
            <div className="bg-slate-900 text-slate-200 rounded-3xl p-6 sm:p-10 shadow-2xl border border-slate-800">
              
              {isSubmitted ? (
                /* Submission Confirmation */
                <div className="text-center py-10 space-y-6 animate-in fade-in zoom-in-95 duration-200">
                  <div className="w-20 h-20 rounded-full bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 flex items-center justify-center mx-auto shadow-inner">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-slate-300 max-w-md mx-auto">
                      Our senior strategy team is already reviewing your website (<strong className="text-white">{formData.currentWebsite}</strong>). We will send your custom 360° growth audit and proposal to <strong className="text-white">{formData.email}</strong> shortly.
                    </p>
                  </div>

                  <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 text-xs text-slate-300 max-w-md mx-auto space-y-1">
                    <div className="font-bold text-white">What happens next?</div>
                    <div className="text-slate-400">1. We run deep technical and competitor scans on your domain.</div>
                    <div className="text-slate-400">2. Jana or Lakshmi will reach out to confirm your strategy call.</div>
                  </div>
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-bold border border-slate-700 transition-colors cursor-pointer"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      {[1, 2, 3].map((step) => (
                        <div
                          ...
                          className={`w-7 h-1.5 rounded-full transition-all ${
                            step <= activeStep ? 'bg-indigo-500' : 'bg-slate-800'
                          }`}
                        />
                      ))}
                    </div>
                  ...
                  {calculatorState && (
                    <div className="p-3 rounded-xl bg-indigo-500/10 border border-indigo-500/20 text-xs text-indigo-300 flex items-center justify-between">
                      ...
                      <span className="font-bold text-indigo-400">Applied</span>
                    </div>
                  )}
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className={`w-4 h-4 rounded-full border flex items-center justify-center ${
                                isSelected ? 'border-indigo-400 bg-white text-indigo-600' : 'border-slate-700'
                              }`}>
                                {isSelected && <CheckCircle2 className="w-3.5 h-3.5 fill-indigo-600 text-white" />}
                              </div>
                            </button>
                          );
                        })}
                  ...
                  {activeStep === 2 && (
                    <div className="space-y-5 animate-in fade-in duration-150">
                      <div className="space-y-1.5">
                        <label htmlFor="enquiry-website" className="text-xs font-semibold text-slate-300 block">
                          Current Website URL <span className="text-indigo-400">*</span>
                        </label>
                        <input
                          id="enquiry-website"
                          type="text"
                          ...
                          className="w-full px-4 py-3 rounded-xl border border-slate-800 bg-slate-950 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
                        />
                      </div>

                      <div className="space-y-1.5">
                        <label htmlFor="enquiry-budget" className="text-xs font-semibold text-slate-300 block">
                        ...
                        <select
                          ...
                          className="w-full px-4 py-3 rounded-xl border border-slate-800 bg-slate-950 text-sm text-white focus:outline-none focus:border-indigo-500"
                        >
                          {budgetOptions.map((b) => (
                      ...
                      <div className="space-y-1.5">
                        <label htmlFor="enquiry-timeline" className="text-xs font-semibold text-slate-300 block">
                  ...
                  {activeStep === 3 && (
                    <div className="space-y-4 animate-in fade-in duration-150">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          <label htmlFor="enquiry-fullname" className="text-xs font-semibold text-slate-300 block">
                          ...
                          <input
                            ...
                            className="w-full px-4 py-2.5 rounded-xl border border-slate-800 bg-slate-950 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-indigo-500"
                          />
                        </div>

                        <div className="space-y-1.5">
                          <label htmlFor="enquiry-email" className="text-xs font-semibold text-slate-300 block">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          <label htmlFor="enquiry-phone" className="text-xs font-semibold text-slate-300 block">
                        ...
                        <div className="space-y-1.5">
                          <label htmlFor="enquiry-company" className="text-xs font-semibold text-slate-300 block">
                            Company Name
                          </label>
                          <input
                            id="enquiry-company"
                      ...
                      <div className="space-y-1.5">
                        <label htmlFor="enquiry-notes" className="text-xs font-semibold text-slate-300 block">
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-2 rounded-xl border border-slate-800 bg-slate-950 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-indigo-500 resize-none"
                        />
                      </div>
                    </div>
                  )}
                  ...
                  <div className="pt-3 border-t border-slate-800 flex items-center justify-between gap-4">
                    {activeStep > 1 ? (
                      <button
                        ...
                        className="px-5 py-2.5 rounded-full bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-bold border border-slate-700 transition-colors cursor-pointer"
                      >
                        Back
                      </button>
                    ) : (
                    ...
                    {activeStep < 3 ? (
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold transition-all cursor-pointer shadow-lg shadow-indigo-600/25"
                      >
                        <span>Continue</span>
                      ...
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-extrabold transition-all shadow-lg shadow-indigo-600/30 cursor-pointer disabled:opacity-50"
                      >
                        {isSubmitting ? (
                          <>
