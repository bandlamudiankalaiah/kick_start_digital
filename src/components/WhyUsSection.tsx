  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {pillars.map((pillar, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-6 rounded-2xl bg-zinc-50 border border-zinc-200/80 hover:border-zinc-300 hover:bg-zinc-50/80 transition-all space-y-3 flex flex-col justify-between"
              >
                <div className="space-y-3">
                  <div className="w-10 h-10 rounded-xl bg-zinc-950 text-emerald-400 flex items-center justify-center shadow-xs">
        ...
        <div className="bg-zinc-950 rounded-2xl text-white p-6 sm:p-10 shadow-xl border border-zinc-800">
            ...
            <table className="w-full text-left border-collapse min-w-[600px]">
              <thead>
                <tr className="border-b border-zinc-800 text-xs font-semibold text-zinc-400 uppercase tracking-wider">
                  ...
                  <th className="py-3.5 px-4 w-1/3 text-emerald-400 bg-zinc-900/80 rounded-t-xl">
                    ⚡ Kickstart Digital
                  </th>
                  <th className="py-3.5 pl-4 w-1/3 text-zinc-400">
              ...
              <tbody className="divide-y divide-zinc-800/80 text-xs sm:text-sm">
                {COMPARISON_DATA.map((row, idx) => (
                  <tr key={idx} className="hover:bg-zinc-900/40 transition-colors">
                    ...
                    <td className="py-4 px-4 bg-zinc-900/60 font-medium text-emerald-300">
